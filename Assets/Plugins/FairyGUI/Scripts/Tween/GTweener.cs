...
namespace FairyGUI {
    ...
    public class GTweener {
        ...
        private Func<bool> _isPauseConditional;

        public GTweener SetPauseConditional(Func<bool> conditional) {
            _isPauseConditional = conditional;
            return this;
        }
        ...
        void Update() {
            ...
            _normalizedTime = EaseManager.Evaluate(_easeType, reversed ? (_duration - tt) : tt, _duration, _easeOvershootOrAmplitude, _easePeriod, _customEase);
