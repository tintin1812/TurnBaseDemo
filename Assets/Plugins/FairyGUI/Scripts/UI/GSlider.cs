...
namespace FairyGUI {
    ...
    public class GSlider : GComponent {
        ...
        override protected void ConstructExtension(ByteBuffer buffer) {
            ...
            onTouchMove.Add(__gripTouchMove);
            onTouchEnd.Add(__gripTouchEnd);
            // onTouchBegin.Add(__barTouchBegin);
            // onTouchMove.Add(__barTouchMove);
        }
        ...
        private void __barTouchMove(EventContext context) {
            Debug.Log("__barTouchMove");
        }
    }
}