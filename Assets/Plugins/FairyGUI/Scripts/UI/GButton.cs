...
namespace FairyGUI {
    ...
    public class GButton : GComponent, IColorGear {
        ...
        public bool selected {
            ...
            set {
                ...
                if (_selected != value) {
                    ...
                    if (_relatedController != null && parent != null && !parent._buildingDisplayList) {
                        if (_selected) {
        ...
        private void __touchEnd() {
            if (_down) {
                ...
                if (_mode == ButtonMode.Common) {
                    ...
                    if (!_over && _buttonController != null && (_buttonController.selectedPage == OVER || _buttonController.selectedPage == SELECTED_OVER)) {
                        SetCurrentState();
                    }
                }
            }
        ...
        public static bool IgnoreSoundEffect { get; set; } = false;

        private void __click() {
            if (sound != null && sound.nativeClip != null && !IgnoreSoundEffect) {
                Stage.inst.PlayOneShotSound(sound.nativeClip, soundVolumeScale);
                IgnoreSoundEffect = true;
            }
